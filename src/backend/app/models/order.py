...
class Order(Base):
    ...
    tour_date_id = Column(UUID(as_uuid=True), ForeignKey("tour_dates.id"), nullable=True)
    attraction_id = Column(UUID(as_uuid=True), ForeignKey("attractions.id"), nullable=True)
    attraction_ticket_id = Column(UUID(as_uuid=True), ForeignKey("attraction_tickets.id"), nullable=True)
