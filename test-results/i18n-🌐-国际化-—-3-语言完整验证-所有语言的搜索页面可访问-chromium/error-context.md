...
- Name: i18n.spec.ts >> 🌐 国际化 — 3 语言完整验证 >> 所有语言的搜索页面可访问
- Location: tests/e2e/i18n.spec.ts:119:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/search
Call log:
