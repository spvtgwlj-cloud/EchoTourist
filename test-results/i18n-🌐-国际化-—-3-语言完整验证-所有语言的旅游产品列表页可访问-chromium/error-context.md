...
- Name: i18n.spec.ts >> 🌐 国际化 — 3 语言完整验证 >> 所有语言的旅游产品列表页可访问
- Location: tests/e2e/i18n.spec.ts:99:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/tours
Call log:
  - navigating to "http://localhost:3000/en/tours", waiting until "load"
