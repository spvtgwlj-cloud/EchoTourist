...
- Name: error-pages.spec.ts >> 🔗 无效路由处理 >> 深度嵌套的不存在路径
- Location: tests/e2e/error-pages.spec.ts:80:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/a/b/c/d/e/f/g
Call log:
  - navigating to "http://localhost:3000/zh/a/b/c/d/e/f/g", waiting until "load"
