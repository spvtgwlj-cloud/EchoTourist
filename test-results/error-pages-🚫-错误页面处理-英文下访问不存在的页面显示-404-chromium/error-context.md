...
- Name: error-pages.spec.ts >> 🚫 错误页面处理 >> 英文下访问不存在的页面显示 404
- Location: tests/e2e/error-pages.spec.ts:16:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/nonexistent-page-xyz-123
Call log:
  - navigating to "http://localhost:3000/en/nonexistent-page-xyz-123", waiting until "load"
