...
- Name: tours.spec.ts >> 📄 旅游产品详情 — 完整功能 >> 从列表页导航到详情页 URL 格式正确
- Location: tests/e2e/tours.spec.ts:87:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/tours
Call log:
  - navigating to "http://localhost:3000/zh/tours", waiting until "load"
