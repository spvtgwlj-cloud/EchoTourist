...
- Name: error-pages.spec.ts >> 🔗 无效路由处理 >> 访问无效的 locale 前缀
- Location: tests/e2e/error-pages.spec.ts:67:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/xx/some-page
Call log:
  - navigating to "http://localhost:3000/xx/some-page", waiting until "load"
