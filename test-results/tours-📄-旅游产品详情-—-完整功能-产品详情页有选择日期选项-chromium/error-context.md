...
- Name: tours.spec.ts >> 📄 旅游产品详情 — 完整功能 >> 产品详情页有选择日期选项
- Location: tests/e2e/tours.spec.ts:77:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/tours/beijing-essence-3-day
Call log:
  - navigating to "http://localhost:3000/zh/tours/beijing-essence-3-day", waiting until "load"
