...
- Name: tours.spec.ts >> 📄 旅游产品详情 — 完整功能 >> 产品详情页显示核心信息
- Location: tests/e2e/tours.spec.ts:62:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/tours/forbidden-city-royal-walk
Call log:
  - navigating to "http://localhost:3000/zh/tours/forbidden-city-royal-walk", waiting until "load"
