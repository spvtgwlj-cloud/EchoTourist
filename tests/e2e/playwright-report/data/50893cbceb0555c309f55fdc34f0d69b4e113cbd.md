...
- Name: i18n.spec.ts >> 🌐 国际化 — 3 语言完整验证 >> 首页使用 Español (es) 渲染
- Location: tests/e2e/i18n.spec.ts:11:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/es
Call log:
  - navigating to "http://localhost:3000/es", waiting until "load"
