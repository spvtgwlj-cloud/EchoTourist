...
- Name: destinations.spec.ts >> 🏙️ 目的地详情 >> 目的地详情页可访问: xian
- Location: tests/e2e/destinations.spec.ts:56:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/destinations/xian
Call log:
  - navigating to "http://localhost:3000/zh/destinations/xian", waiting until "load"
