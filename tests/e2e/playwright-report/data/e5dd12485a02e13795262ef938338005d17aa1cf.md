...
- Name: error-pages.spec.ts >> 🔗 无效路由处理 >> 访问管理后台不存在的子页面
- Location: tests/e2e/error-pages.spec.ts:74:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/admin/nonexistent-sub-page
Call log:
  - navigating to "http://localhost:3000/zh/admin/nonexistent-sub-page", waiting until "load"
