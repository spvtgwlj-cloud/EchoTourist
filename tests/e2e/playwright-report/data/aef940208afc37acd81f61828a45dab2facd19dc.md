...
- Name: error-pages.spec.ts >> 🚫 错误页面处理 >> 访问不存在的目的地 slug 显示 404
- Location: tests/e2e/error-pages.spec.ts:37:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/destinations/nonexistent-dest-slug
Call log:
  - navigating to "http://localhost:3000/zh/destinations/nonexistent-dest-slug", waiting until "load"
