...
- Name: destinations.spec.ts >> 🌍 目的地列表 >> 目的地卡片可点击进入详情
- Location: tests/e2e/destinations.spec.ts:32:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/destinations
Call log:
  - navigating to "http://localhost:3000/zh/destinations", waiting until "load"
