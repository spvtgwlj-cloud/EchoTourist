...
- Name: tours.spec.ts >> 📄 旅游产品详情 — 完整功能 >> 直接访问产品详情页: xian-terracotta-warriors-2day
- Location: tests/e2e/tours.spec.ts:51:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/tours/xian-terracotta-warriors-2day
Call log:
  - navigating to "http://localhost:3000/zh/tours/xian-terracotta-warriors-2day", waiting until "load"
