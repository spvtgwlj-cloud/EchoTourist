...
- Name: error-pages.spec.ts >> 🚫 错误页面处理 >> 404 页面有返回首页的链接
- Location: tests/e2e/error-pages.spec.ts:47:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/zh/nonexistent-page-xyz-123
Call log:
  - navigating to "http://localhost:3000/zh/nonexistent-page-xyz-123", waiting until "load"
