...
- Name: destinations.spec.ts >> 🏙️ 目的地详情 >> 从目的地详情点击旅游产品进入产品详情
- Location: tests/e2e/destinations.spec.ts:89:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/destinations/beijing
Call log:
  - navigating to "http://localhost:3000/en/destinations/beijing", waiting until "load"
